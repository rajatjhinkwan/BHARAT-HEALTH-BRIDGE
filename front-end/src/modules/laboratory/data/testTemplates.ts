import type { LabTestTemplate } from '../types/lab';

export const LAB_TEST_TEMPLATES: Record<string, LabTestTemplate> = {
  CBC: {
    id: 'CBC',
...
export function resolveTestTemplates(testNames: string[] = []): LabTestTemplate[] {
  const matched = new Map<string, LabTestTemplate>();
