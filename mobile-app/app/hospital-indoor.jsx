...
export default function HospitalIndoorNavigation() {
  ...
  return (
    <ScreenWrapper style={{ backgroundColor: C.background }}>
      <AppHeader title="Hospital Wayfinder" showBack />
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={[styles.heroSection, { backgroundColor: C.cardWhite, borderColor: C.border }]}>
          <View style={{ flex: 1 }}>
            <Text style={[styles.heroTitle, { color: C.textPrimary }]}>{name || 'Hospital Indoor GPS'}</Text>
